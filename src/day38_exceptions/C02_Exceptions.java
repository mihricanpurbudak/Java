...
public class C02_Exceptions {
    public static void main(String[] args) {
       ...
       catch blogunun onundeki paranteze karsilasmayi bekledigimiz exeption i yazabilir
       veya her  turlu exception da devreye girsin istiyorsak
       tum exceptionlarin parenti olan exception i yazabiliriz
         */
                    try {
