...
public class C01_WrapperClasses {
    public static void main(String[] args) {
        /*
        Wrapper class javanin hazir methodlari kullanabilmemiz icin primitive data turlerinin herbiri icin actigi class 'lardir
        int--->Integer
        char--->Character
        ...
        //eger sifre sadece rakamlerdan olusuyorsa kabul etmeyelim

        Scanner scan = new Scanner(System.in);
        System.out.println("Lutfen 5 basmakli bir sifre giriniz");
        ...
        /*
        Wrapper class'lar ilerde kullanabilecegimiz pek cokmethod icerir
        */
